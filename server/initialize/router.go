...
func Routers() *gin.Engine {
	Router := gin.Default()
	imagesRouter := router.RouterGroupApp.Images
	authorRouter := router.RouterGroupApp.Author
	...
	PrivateGroup.Use(middleware.JWTAuth()).Use(middleware.CasbinHandler())
	{
		...
		authorRouter.InitAuthorRouter(PrivateGroup)
		authorRouter.InitAuthorsRouter(PrivateGroup)
		imagesRouter.InitImagesRouter(PrivateGroup)
